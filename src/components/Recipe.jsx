...
const Recipe = () => {
  ...
  const getAllRecipe = async () => {
    let res = await fetch(`https://api.edamam.com/search?q=${searchItem}&app_id=da3abaa1&app_key=3659cc011d784a728d550c44845bfe7f`)
        ...
        {recipes.map((ele) => {
          return <div className="card" style={{ width: '18rem' }}>
            ...
            <div className="card-body">
              ...
              <Link to="/viewrecipe" state={ele} className="btn btn-primary">view recipe</Link>
